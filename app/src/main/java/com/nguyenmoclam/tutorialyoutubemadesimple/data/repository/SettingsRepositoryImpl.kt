    ...
    override fun getSettings(): Flow<Settings> {
        return context.dataStore.data.map { preferences ->
            Settings(
                ...
                showAnswerAfterWrong = preferences[PreferenceKeys.SHOW_ANSWER_AFTER_WRONG] == true,
                autoNextQuestion = preferences[PreferenceKeys.AUTO_NEXT_QUESTION] == true,
                isGoogleSignedIn = preferences[PreferenceKeys.GOOGLE_SIGNED_IN] == true,
